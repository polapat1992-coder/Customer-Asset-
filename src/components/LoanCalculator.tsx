      ...
      <div className="bg-white rounded-2xl border shadow-sm overflow-hidden">
        <div className="p-6 border-b bg-gray-50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">เครื่องคำนวณเงินกู้</h2>
              <p className="text-sm text-gray-500">คำนวณยอดผ่อนชำระต่อเดือนเบื้องต้น</p>
            </div>
          </div>
          <button 
            onClick={() => {
        ...
        <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                ระยะเวลาผ่อน (ปี): <span className="text-blue-600 font-bold ml-2">{years} ปี</span>
              </label>
              <input 
                type="range" 
                min="1" 
          ...
          <div className="bg-blue-50 rounded-2xl p-8 flex flex-col justify-center items-center text-center">
            ...
            <div className="w-full space-y-4 pt-6 border-t border-blue-100">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-blue-600/70">ดอกเบี้ยรวม</span>
              ...
              <div className="flex justify-between text-sm pt-2 border-t border-blue-100">
                <span className="text-blue-600 font-bold">รวมจ่ายทั้งสิ้น</span>
